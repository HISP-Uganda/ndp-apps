...
exports.OutcomeLevelRoute = void 0;
...
exports.OutcomeLevelRoute = react_router_1.createRoute({
    ...
    loader: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                data = queryClient.ensureQueryData(query_options_1.dataElementGroupSetsWithProgramsQueryOptions(engine, "objective", v));
...
function Component() {
    var engine = exports.OutcomeLevelRoute.useRouteContext().engine;
    var _a = exports.OutcomeLevelRoute.useSearch(), v = _a.v, deg = _a.deg, degs = _a.degs, ou = _a.ou, pe = _a.pe, program = _a.program;
    var data = react_query_1.useSuspenseQuery(query_options_1.dataElementGroupSetsWithProgramsQueryOptions(engine, "objective", v)).data;
    var navigate = exports.OutcomeLevelRoute.useNavigate();
