...
exports.SubProgramActionRoute = void 0;
...
exports.SubProgramActionRoute = react_router_1.createRoute({
    ...
    loader: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                data = queryClient.ensureQueryData(query_options_1.dataElementGroupSetsWithProgramsQueryOptions(engine, "sub-intervention4action", v));
...
function Component() {
    var engine = exports.SubProgramActionRoute.useRouteContext().engine;
    var _a = exports.SubProgramActionRoute.useSearch(), v = _a.v, deg = _a.deg, degs = _a.degs, ou = _a.ou, pe = _a.pe, program = _a.program;
    var data = react_query_1.useSuspenseQuery(query_options_1.dataElementGroupSetsWithProgramsQueryOptions(engine, "sub-intervention4action", v)).data;
    var navigate = exports.SubProgramActionRoute.useNavigate();
